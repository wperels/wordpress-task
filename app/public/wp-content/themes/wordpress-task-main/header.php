...
<body <?php body_class(); ?>>
  ...
  <!-- Search Overlay -->
  <div id="search-overlay" class="flex justify-center invisible bg-white/90 backdrop-blur-sm fixed inset-0 z-10">
    <div class="w-[640px] max-w-full pt-4 sm:pt-16 px-4 sm:px-0">
      ...
      <div class="flex justify-between bg-white border-gray-200 border drop-shadow-md">
        <input placeholder="What are you looking for?" type="text" class="flex-1 text-xl text-gray-500 py-5 px-6 outline-none">
      ...
      <div>
        <div class="mt-7 py-7 px-8 bg-white border-gray-200 drop-shadow-md">
          <p class="hidden text-gray-400 text-xl p-5 text-center">Results will appear here.</p>

          <p class="hidden text-red-600 flex items-center">
          ...
          <div class="hidden text-center text-gray-300">
          ...
          <ul class="hidden space-y-4">
            ...
            </svg><span> Example Post Result#1</span></a></li>
            <li><a class="flex items-center text-sm text-teal-700 hover:text-teal-500" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="mr-3" viewBox="0 0 16 16">
              <path d="M4 3.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 .5.5v8a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5z"/>
              <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2zm10-1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1"/>
            </svg><span> Example Post Result#2</span></a></li>
            <li><a class="flex items-center text-sm text-teal-700 hover:text-teal-500" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="mr-3" viewBox="0 0 16 16">
              <path d="M4 3.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 .5.5v8a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5z"/>
              <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2zm10-1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1"/>
            </svg><span> Example Post Result#3</span></a></li>
          </ul>
        </div>
      </div>
    </div>
